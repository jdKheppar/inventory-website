          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M6 12h-2v2h2v-2zm0 4h-2v2h2v-2zm0-8h-2v2h2V8zm12-6h-8c-1.104 0-2 .896-2 2v14c0 1.104.896 2 2 2h8c1.104 0 2-.896 2-2V4c0-1.104-.896-2-2-2zm0 16h-8v-14h8v14zm2-20h-12c-1.104 0-2 .896-2 2h16c0-1.104-.896-2-2-2zm-14 3h-2v2h2V1zm14 0h-2v2h2V1zm-14 3h-2v2h2V4zm14 0h-2v2h2V4zm-14 3h-2v2h2V7zm14 0h-2v2h2V7zm-14 3h-2v2h2v-2zm14 0h-2v2h2v-2z" />
                  </svg>
              ...
              <li>
                <Link
                  href="/suppliers"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("suppliers") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#FFFFFF">
